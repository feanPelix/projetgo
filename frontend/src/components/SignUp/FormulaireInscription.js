...
function FormulaireSignUp(props) {
    ...
    const handleSubmit=async(e)=> {
        ...
        if(validateFields()) {
            ...
            try {
                ...
                const body = { nom, prenom, courriel, phone, adresse, props}; //props is for choix
                const response = await fetch("http://localhost:5000/inscription/form/", {
                    method: "POST",
    ...
    return (
        <div style={{backgroundColor: '#138499'}}>
            ...
            <Form onSubmit={handleSubmit} controlId={"FormSignUp"}>
                <Form.Row>
                ...
                <Form.Row>
                    ...
                    <Form.Group as={"Col"} controlId={"formGridConfirmationPassword"}>
                        <Form.Control type={"password"} placeholder={"Confirmer mot de passe"} value={confirmPassword}
